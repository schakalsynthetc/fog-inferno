...
include "draw.m";
include "sh.m"; sh: Sh; Listnode, Context: import sh; myself: Shellbuiltin;
include "bufio.m"; bufio: Bufio; Iobuf: import bufio;
include "sexprs.m"; sexprs: Sexprs; Sexp: import sexprs;
...
{ ctxt.setlocal("status", ref Listnode(nil, val) :: nil); return val; }
...
{ if (n.word!=nil) return n.word; if (n.cmd!=nil) n.word=sh->cmd2string(n.cmd); return n.word; }
