...
;;;-----------------------------
;;; modified by Stéphane Rollandin for ULisp
;;; ULisp specific:
;;;-----------------------------
;;; The input tests read this file expecting it to be named "ulisp/tests/r4rstest.scm".
;;;-----------------------------
...
(test #t call-with-input-file (system-path "ulisp/tests/r4rstest.scm") input-port?)
(define this-file (open-input-file (system-path "ulisp/tests/r4rstest.scm")))
