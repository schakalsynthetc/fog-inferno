function ArrayIterator(array) {
    this.array = array; this.index = 0;
}

ArrayIterator.prototype.getChar = function() {
    if (this.array.length < this.index + 1) {throw ("array too short");}
...
ArrayIterator.prototype.getLong = function() {
    if (this.array.length < this.index + 4) {throw ("array too short");}
    return (
        ((this.array[this.index++] & 0xFF) << 0) |
        ((this.array[this.index++] & 0xFF) << 8) |
...
ArrayIterator.prototype.getBytes = function(bytes) {
    if (this.array.length < this.index + bytes) {throw ("array too short");}
...
ArrayIterator.prototype.getPoint = function() {
    var that=this; return new Point(that.getLong(), that.getLong());
}

ArrayIterator.prototype.getRect = function() {
    var that=this; return new Rect(that.getPoint(), that.getPoint());
}
...
ArrayIterator.prototype.strtoul = function() {
    ...
    for (; this.index < this.array.length; ++this.index) {
        if (this.array[this.index] != spc) break;
    }
    for (; this.index < this.array.length; ++this.index) {
