Httpd: module {
	...
	SVR_ROOT : con "/w/eb/y/";
	MAGICPATH : con "/w/eb/x/httpd/"; # must end in /
	HTTPLOG : con "/w/eb/j/log/httpd";
	DEBUGLOG : con "/w/eb/j/log/debug";
	HTTP_SUFF : con "/w/eb/x/httpd/suffix";
	REWRITE   : con "/w/eb/x/httpd/rewrite";
